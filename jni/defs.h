...
/**
 * The path to the keymaster application.
 */
...
/**
 * The name of the keymaster application
 */
#define KEYMASTER_APP_NAME ("keymaster")
...
/**
 * The length of the KeyMaster KEK.
 */
#define KEK_LENGTH (0x10)

/**
 * The length of the KeyMaster HMAC Key.
 */
