...
/**
 * A structure which is used to house all the data needed to interface with Widevine.
 */
...
/**
 * A structure which is used to house all the data needed to interface with keymaster.
 */
...
/**
 * Initializes a new handle which can be used to communicate with Widevine.
 * @return The handle used to communicate with Widevine.
 */
struct qcom_wv_handle* initialize_wv_handle();

/**
 * Initializes a new handle which can be used to communicate with Keymaster.
 * @return The handle used to communicate with Keymaster.
 */
