...
/**
 * The address of the code cave in the TrustZone kernel to which we write a small stub.
 */
#define CAVE_ADDR (0xFE80D774)

/**
 * The address of the function pointer to qsee_hmac in the syscall table.
 */
#define QSEE_HMAC_FUNCPTR (0xFE81BABC)

/**
 * The location of the flush data cache function in the TrustZone kernel.
 */
#define FLUSH_DATA_CACHE (0xFE80DCA8)

/**
 * The location of the invalidate data cache function in the TrustZone kernel.
 */
#define INVALIDATE_DATA_CACHE (0xFE80DCE8)
